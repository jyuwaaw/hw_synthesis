...
set_app_var synthetic_library "./lib/NanGate_15nm_OCL.db"
set_app_var link_library "./lib/NanGate_15nm_OCL.db"
set_app_var target_library "./lib/NanGate_15nm_OCL.db"
